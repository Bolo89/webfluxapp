...
public class ReactiveappApp {

  private static final Logger log = LoggerFactory.getLogger(ReactiveappApp.class);

  private static final String SEPARATOR = "----------------------------------------------------------";
  protected static final String LF = "\n";

  public static void main(String[] args) {
    Environment env = SpringApplication.run(ReactiveappApp.class, args).getEnvironment();
